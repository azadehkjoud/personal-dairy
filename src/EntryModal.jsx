...
const EntryModal = ({ entry, closeModal, onEdit }) => {
  return (
    <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white p-10 rounded-lg shadow-lg w-11/12 md:w-3/4 lg:w-2/3 flex"> {/* Adjusted width and padding */}
        {/* Left side: Image */}
        <div className="w-1/3">
          <img
        ...
        {/* Right side: Content */}
        <div className="w-2/3 px-6"> {/* Increased padding on the right side */}
          {/* Title */}
          <h2 className="text-2xl font-bold mb-2">{entry.title || "PLACE IMPRESSIVE TITLE HERE"}</h2> {/* Increased title size */}
          
          {/* Date */}
          <p className="text-sm text-gray-500 mb-4">{entry.date || "10/22/2024"}</p>
