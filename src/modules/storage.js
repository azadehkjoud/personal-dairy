// HELPER FUNCTIONS RELATED TO LOCAL STORAGE OPERATIONS
 ...
 * @param storageName the name of the localStorage to sort
 * @param sortBy the field to sort by. here: sort by 'date'
